...
```
https://github.com/CNCSMonster/learn-claude-code-notes
```

## 步骤 2: 初始化 Git 并提交

```bash
cd learn-claude-code-notes
...
# 提交
git commit -m "Initial commit: Learn Claude Code Notes"

# 添加远程仓库
git remote add origin https://github.com/CNCSMonster/learn-claude-code-notes.git
...
### book.toml
```toml
site-url = "/learn-claude-code-notes/"
git-repository-url = "https://github.com/CNCSMonster/learn-claude-code-notes"
edit-url-template = "https://github.com/CNCSMonster/learn-claude-code-notes/edit/main/src/{path}"
```
...
```
https://github.com/CNCSMonster/learn-claude-code-notes/actions
```
